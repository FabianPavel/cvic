...
def random():
    """
    This function will get number between 0 and 10 that user want to exclude
    then will print numbers between 0 and 10 without the excluded number
    """
    excluded = input("Zadejte číslo mezi 0 a 10 které chcete vynechat: ")
