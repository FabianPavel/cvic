...
x = 0
#global = 1 - global nemůžeme použít jako název proměnné jelikož má v pythonu svůj vlastní význam
global_var = 1
PI = 3.14
city = "Opava"
#hilda@sspu-opava.cz = 'Hilda Dokonalá' - název proměnné nemůže obsahovat znaky jako @,-
hilda_sspu_opava_cz = 'Hilda Dokonalá'
password2 = 'TajneHeslo'
#007agent = 'James Bond' - proměnné nemohou začínat číslem
agent007 = 'James Bond'
